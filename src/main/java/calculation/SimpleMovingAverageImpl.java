 ...
 */
public class SimpleMovingAverageImpl implements SimpleMovingAverage {
    private final static Logger log = LoggerFactory.getLogger(SimpleMovingAverageImpl.class);
